...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local ptr @find(ptr noundef %root, i64 noundef %key, i1 noundef zeroext %verbose, ptr noundef %leaf_out) #0 !sec !{!"private", !"private", !{!"private", !"public", !"public", !"private"}} {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @find_and_print_range(ptr noundef %root, i64 noundef %key_start, i64 noundef %key_end, i1 noundef zeroext %verbose) #0 !sec !{!"void", !"public", !{!"public", !"public", !"public", !"public"}} {
entry:
  %root.addr = alloca ptr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @find_range(ptr noundef %root, i64 noundef %key_start, i64 noundef %key_end, i1 noundef zeroext %verbose, ptr noundef %returned_keys, ptr noundef %returned_pointers) #0 !sec !{!"public", !"public", !{!"private", !"public", !"public", !"public", !"public", !"private"}} {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
; pc and ret label mismatch
define dso_local ptr @find_leaf(ptr noundef %root, i64 noundef %key, i1 noundef zeroext %verbose) #0 !sec !{!"private", !"public", !{!"private", !"public", !"public"}} {
entry:
  %retval = alloca ptr, align 8
  %root.addr = alloca ptr, align 8
  %key.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @cut(i64 noundef %length) #0 !sec !{!"public", !"public", !{!"public"}} {
entry:
  %retval = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
; pc and ret label mismatch
define dso_local ptr @alloc_node() #0 !sec !{!"private", !"public", !{}} {
entry:
  %n = alloca ptr, align 8
  %i = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal ptr @allocate(i64 noundef %size, i64 noundef %alignment) #0 !sec !{!"public", !"public", !{!"public", !"public"}} {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_node(ptr noundef %n) #0 !sec !{!"void", !"public", !{!"private"}} {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_record(ptr noundef %r) #0 !sec !{!"void", !"public", !{!"private"}} {
entry:
...
entry:
  ...
  %call = call ptr (i64, ...) @alloc_record()
...
; Function Attrs: noinline nounwind optnone uwtable
; pc and ret label mismatch
define dso_local ptr @make_node() #0 !sec !{!"private", !"public", !{}} {
entry:
  %new_node = alloca ptr, align 8
  %call = call ptr (i64, ...) @alloc_node()
...
; Function Attrs: noinline nounwind optnone uwtable
; pc and ret label mismatch
define internal ptr @allocate_align64(i64 noundef %size) #0 !sec !{!"private", !"public", !{!"public"}} {
entry:
  %size.addr = alloca i64, align 8
  %memptr = alloca ptr, align 8
  store i64 %size, ptr %size.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @get_left_index(ptr noundef %parent, ptr noundef %left) #0 !sec !{!"public", !"public", !{!"private", !"private"}} {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @get_neighbor_index(ptr noundef %n) #0 !sec !{!"public", !"public", !{!"private"}} {
entry:
  %n.addr = alloca ptr, align 8
  %i = alloca i64, align 8
  store ptr %n, ptr %n.addr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @destroy_tree_nodes(ptr noundef %root) #0 !sec !{!"void", !"public", !{!"private"}} {
entry:
  %root.addr = alloca ptr, align 8
  %i = alloca i64, align 8
  store ptr %root, ptr %root.addr, align 8
