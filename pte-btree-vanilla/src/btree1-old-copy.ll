...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @enqueue(ptr noundef %0) #0 !sec !{!"void", !"public", !{!"nosec"}} {
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @print_leaves(ptr noundef %0) #0 !sec !{!"void", !"public", !{!"nosec"}} {
  %2 = alloca ptr, align 8
...
19:                                               ; preds = %3
  ...
  %d24 = call i64 @declassify.i64(i64 noundef %24)
  %25 = call i32 (ptr, ...) @printf(ptr noundef @.str.18, ptr noundef %20, i64 noundef %21, i64 noundef %d24)
  br label %26
...
40:                                               ; preds = %33
  ...
  %47 = call i32 (ptr, ...) @printf(ptr noundef @.str.12, i64 noundef %d46)
  br label %48
...
51:                                               ; preds = %33
  ...
  %57 = load i64, ptr %56, align 8
  %d57 = call i64 @declassify.i64(i64 noundef %57)
  %58 = call i32 (ptr, ...) @printf(ptr noundef @.str.22, i64 noundef %d57)
  br label %59
...
105:                                              ; preds = %98
  ...
  %d111 = call i64 @declassify.i64(i64 noundef %111)
  %112 = call i32 (ptr, ...) @printf(ptr noundef @.str.12, i64 noundef %d111)
  br label %113
...
116:                                              ; preds = %98
  ...
  %d122 = call i64 @declassify.i64(i64 noundef %122)
  %123 = call i32 (ptr, ...) @printf(ptr noundef @.str.25, i64 noundef %d122)
  br label %124
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @cut(i64 noundef %0) #0 !sec !{!"nosec", !"nosec", !{!"private"}} {
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @free_record(ptr noundef %0) #0 !sec !{!"void", !"nosec", !{!"nosec"}} {
  %2 = alloca ptr, align 8
  store ptr %0, ptr %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local ptr @make_record(i64 noundef %0) #0 !sec !{!"public", !"public", !{!"nosec"}} {
  %2 = alloca i64, align 8
  %3 = alloca ptr, align 8
  store i64 %0, ptr %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local ptr @insert_into_leaf(ptr noundef %0, i64 noundef %1, ptr noundef %2) #0 !sec !{!"nosec", !"nosec", !{!"nosec", !"nosec", !"nosec"}} {
  %4 = alloca ptr, align 8
  %5 = alloca i64, align 8
  %6 = alloca ptr, align 8
  %7 = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local ptr @insert_into_leaf_after_splitting(ptr noundef %0, ptr noundef %1, i64 noundef %2, ptr noundef %3) #0 !sec !{!"public", !"public", !{!"nosec", !"nosec", !"nosec", !"nosec"}} {
  %5 = alloca ptr, align 8
  %6 = alloca ptr, align 8
  %7 = alloca i64, align 8
  %8 = alloca ptr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local ptr @insert_into_parent(ptr noundef %0, ptr noundef %1, i64 noundef %2, ptr noundef %3) #0 !sec !{!"public", !"public", !{!"nosec", !"nosec", !"nosec", !"nosec"}} {
  %5 = alloca ptr, align 8
  %6 = alloca ptr, align 8
  %7 = alloca ptr, align 8
  %8 = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local ptr @insert_into_node_after_splitting(ptr noundef %0, ptr noundef %1, i64 noundef %2, i64 noundef %3, ptr noundef %4) #0 !sec !{!"public", !"public", !{!"public", !"nosec", !"nosec", !"nosec", !"nosec"}} {
  %6 = alloca ptr, align 8
  %7 = alloca ptr, align 8
  %8 = alloca i64, align 8
  %9 = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local ptr @insert_into_new_root(ptr noundef %0, i64 noundef %1, ptr noundef %2) #0 !sec !{!"public", !"public", !{!"nosec", !"nosec", !"nosec"}} {
  %4 = alloca ptr, align 8
  %5 = alloca i64, align 8
  %6 = alloca ptr, align 8
  %7 = alloca ptr, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i64 @get_neighbor_index(ptr noundef %0) #0 !sec !{!"public", !"public", !{!"nosec"}} {
  %2 = alloca ptr, align 8
  %3 = alloca i64, align 8
  store ptr %0, ptr %2, align 8
  store i64 0, ptr %3, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local ptr @remove_entry_from_node(ptr noundef %0, i64 noundef %1, ptr noundef %2) #0 !sec !{!"public", !"public", !{!"nosec", !"nosec", !"nosec"}} {
  %4 = alloca ptr, align 8
  %5 = alloca i64, align 8
  %6 = alloca ptr, align 8
  %7 = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local ptr @adjust_root(ptr noundef %0) #0 !sec !{!"public", !"public", !{!"nosec"}} {
  %2 = alloca ptr, align 8
  %3 = alloca ptr, align 8
  %4 = alloca ptr, align 8
  store ptr %0, ptr %3, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local ptr @coalesce_nodes(ptr noundef %0, ptr noundef %1, ptr noundef %2, i64 noundef %3, i64 noundef %4) #0 !sec !{!"public", !"public", !{!"public", !"public", !"nosec", !"nosec", !"nosec"}} {
  %6 = alloca ptr, align 8
  %7 = alloca ptr, align 8
  %8 = alloca ptr, align 8
  %9 = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local ptr @delete_entry(ptr noundef %0, ptr noundef %1, i64 noundef %2, ptr noundef %3) #0 !sec !{!"public", !"public", !{!"nosec", !"nosec", !"nosec", !"nosec"}} {
  %5 = alloca ptr, align 8
  %6 = alloca ptr, align 8
  %7 = alloca ptr, align 8
  %8 = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local ptr @redistribute_nodes(ptr noundef %0, ptr noundef %1, ptr noundef %2, i64 noundef %3, i64 noundef %4, i64 noundef %5) #0 !sec !{!"nosec", !"nosec", !{!"nosec", !"nosec", !"nosec", !"nosec", !"nosec", !"nosec"}} {
  %7 = alloca ptr, align 8
  %8 = alloca ptr, align 8
  %9 = alloca ptr, align 8
  %10 = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local ptr @delete(ptr noundef %0, i64 noundef %1) #0 !sec !{!"public", !"public", !{!"nosec", !"nosec"}} {
  %3 = alloca ptr, align 8
  %4 = alloca i64, align 8
  %5 = alloca ptr, align 8
  %6 = alloca ptr, align 8
